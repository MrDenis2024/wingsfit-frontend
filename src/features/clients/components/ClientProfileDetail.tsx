...
import {Box, CardMedia, Collapse, Container, IconButton, Theme, Typography, useMediaQuery} from "@mui/material";
...
const ClientProfileDetail:React.FC<ClientsProfileDetailsProps> = ({clientsProfile, id,isOwner}) => {
                    ...
                    <Container maxWidth="lg" sx={{ py: 5 }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {clientsProfile?.user.firstName} {clientsProfile?.user.lastName}
                                        </Typography>
                                        {isOwner && (
                                        <Link
                                            to={`/edit-client/${id}`}
                      ...
                      {clientsProfile?.user.dateOfBirth?.slice(0, 10) || "N/A"}
                                    ...
                                    >
                                        ...
                                        {clientsProfile?.user.gender === "other" && <TransgenderIcon />}
