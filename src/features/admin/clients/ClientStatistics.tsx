...
const ClientStatistics = () => {
  ...
  return (
    <Box p={3}>
      <Typography variant="h5" textAlign="center" sx={{fontSize: {xs: "20px", sm: "24px"}}}>
        Client Statistics
      </Typography>
      {adminClientsFetching ? (
        ...
        <>
          <Stack mt={3}>
            <Typography variant="h6" fontWeight="bold" sx={{fontSize: {xs: '16px', sm: '20px'}}}>
          ...
          <Paper elevation={3} sx={{mt: 3, p: 2}}>
            ...
            >
              <Typography sx={{fontWeight: 'bold', width: '20%'}}>Name</Typography>
              <Typography sx={{fontWeight: 'bold', width: '15%'}}>Role</Typography>
              <Typography sx={{fontWeight: 'bold', width: '20%'}}>Created At</Typography>
              <Typography sx={{fontWeight: 'bold', width: '20%'}}>Updated At</Typography>
              <Typography sx={{fontWeight: 'bold', flexGrow: 1, textAlign: 'center', ms: 0}}>
                Last Activity
              </Typography>
            </Stack>
