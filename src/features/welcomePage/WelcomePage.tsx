  ...
  return (
    <Box>
      ...
      >
        ...
        />
        <Stack boxSizing={"border-box"} maxWidth="500px" position="absolute" top={"220px"} ml="20px">
          <Typography
            sx={{
              fontSize: "32px",
              lineHeight: "1.23",
          ...
          <Stack direction="row" gap={2} flexWrap="wrap" mt={3}>
            <NavLink to="/login/client" style={{textDecoration: "none"}}>
              <BeRoleButton text="Быть тренером!" color="#ffffff"/>
            </NavLink>
          ...
          <Stack spacing={4} sx={{maxWidth: "300px", width: "100%"}}>
            <Box display="flex" alignItems="flex-start" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="caption">
                  Тренировки не в записи вы тренируетесь в группе или индивидуально в режиме видео звонка
                </Typography>
              </Box>
            ...
            <Box display="flex" alignItems="flex-start" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="caption">
                  Очевидно что занимаясь в удобном месте вы существенно экономите время
                </Typography>
              </Box>
            ...
            <Box display="flex" alignItems="flex-start" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="caption">
                  Статистически, тренировки по видео связи существенно эффективнее тренировок в записи
                </Typography>
              </Box>
          ...
          <Stack spacing={4} sx={{maxWidth: "300px", width: "100%"}}>
            <Box display="flex" alignItems="flex-start" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="caption">
                  Благодаря формату вы всегда под контролем тренера и можете общаться вживую
                </Typography>
              </Box>
              <Chat fontSize="large"/>
            </Box>
            ...
            <Box display="flex" alignItems="flex-start" justifyContent="space-between">
              <Box>
                ...
                <Typography variant="caption">
                  Небольшие группы позволяют адаптировать занятие под любого участника
                </Typography>
              </Box>
      ...
      <Box sx={{backgroundColor: "#0cc5d6", paddingY: "60px", textAlign: "center"}}>
        <NavLink to="/login/client" style={{textDecoration: "none"}}>
          <TryFreeButton text="Попробовать бесплатно!" color="#000000" backgroundColor="transparent"
      ...
      >
        ...
        >
          Ты фитнес тренер? Или может преподаешь йогу, танцы, пилатес? Присоединяйся к команде WingsFit
        </Typography>
          ...
          <Stack spacing={4}>
            ...
            >
              ...
              <Box sx={{textAlign: "left"}}>
                ...
                <Typography variant="caption">
                  С помощью платформы WingsFit удобно управлять группами, следить за оплатами, находить новых клиентов
                </Typography>
              </Box>
            </Box>
            <Box
            ...
            >
              ...
              <Box sx={{textAlign: "left"}}>
                ...
                <Typography variant="caption">
                  Пользуясь сервисом тебе не нужен ни менеджер, ни маркетолог ни, тем более, начальник в клубе. Все
                  заменяет система
                </Typography>
              </Box>
            </Box>
      ...
      <Box sx={{paddingY: "60px", marginX: "20px"}}>
        ...
        <Stack direction="row" flexWrap="wrap" justifyContent={{xs: "center", lg: "space-between",}} spacing={4} sx={{padding: 4}}>
          {cards.map((card) => (
            <TrainingCard key={card.id} firstName={card.firstName} lastName={card.lastName} image={card.image} date={card.date}
                          time={card.time} description={card.description}/>
          ))}
        </Stack>
      ...
      <Stack direction={"row"} justifyContent="center" gap={2} flexWrap="wrap"
        ...
        <NavLink to="/login/trainer" style={{textDecoration: "none"}}>
          <TryFreeButton text="Стать тренером!" color="#000000" backgroundColor="#ffffff" border="1px solid #000000"/>
        </NavLink>
        <NavLink to="/login/client" style={{textDecoration: "none"}}>
          <TryFreeButton text="Попробовать тренировки!" color="#000000" backgroundColor="#ffffff"
