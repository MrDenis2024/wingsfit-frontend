...
import { Box, Button, CardMedia, CircularProgress, Collapse, Dialog, IconButton, Typography } from "@mui/material";
...
const TrainerCertificates = () => {
    ...
    const [selectedCertificate, setSelectedCertificate] = useState<{ _id: string; title: string; image: string;} | null>(null);
    ...
    const handleClickOpen = (certificate: { _id: string; title: string; image: string; }) => {
    ...
    const handleDeleteCertificate = async () => {
        if (selectedCertificate && oneTrainer) {
            if (window.confirm(`Are you sure you want to delete the certificate "${selectedCertificate.title}"?`)) {
                try {
